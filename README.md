...
**Senior Frontend Architect** specializing in React, TypeScript, and micro-frontends, with over 5 years of experience building scalable web applications and modernizing legacy systems.
...
| Project | Description |
| :--- | :--- |
| **ERP Legacy Migration** | Full migration of a financial ERP from desktop to modern SPA (React + TypeScript). |
| **Component Library** | Designed and implemented a design system with Storybook, reducing UI development time by 30%. |
| **Micro-frontends** | Implemented architecture with Nx, Webpack Module Federation, and deployed with Docker/Kubernetes. |
| **Data Visualization** | Financial dashboards with AG-Grid and HighCharts for real-time analytics. |

> ⚠️ *Real-world projects were developed for companies with private code. This profile showcases technical demonstrations of my approach and standards.*
